...
var vmzde_version = "2025.08.01.04";
...
by_btn.click(function(){
    ...
    zoom = zoom > 19 ? 19 : zoom;
    zoom = zoom - 3;
  var mapsUrl = 'https://www.bayerninfo.de/de/karte?bounds=' + lat+20 + '%2C' + lon+20 + '%2C' + lat-20 + '%2C' + lon-20 + '%2C' + &traffic=all;
